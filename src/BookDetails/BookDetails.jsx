...
const BookDetails = () => {
    ...
    const isBookInWishlist = wishlist.some(wishlistBook => wishlistBook.id === book.id);
    ...
    const removeFromWishlist = (id) => {
        const updatedWishlist = wishlist.filter(wishlistBook => wishlistBook.id !== id);
            ...
            <div className="flex-1">
                ...
                <div className="mb-3">
                    {book.authors.map((author) => (
                        <ul className="flex items-center gap-2 text-lg" key={author.name}>
                            <IoPerson />
                            {author.name}
                        </ul>
                    ))}
                ...
                <div className="flex justify-between gap-6">
                    <div className="flex-1">
                        ...
                        {book.subjects.map((subject) => (
                            <ul className="list-disc flex items-center gap-2 text-md" key={subject}>
                    ...
                    <div className="flex-1">
                        ...
                        {book.bookshelves.map((bookshelf) => (
                            <ul className="list-disc flex items-center gap-2 text-md" key={bookshelf}>
